...
const file_apiserver_v1_healthz_proto_rawDesc = "" +
	"\n" +
	"\x1aapiserver/v1/healthz.proto\x12\x02v1\"s\n" +
	...
	"\tUnhealthy\x10\x01B1Z/github.com/wshadm/miniblog/pkg/api/server/v1;v1b\x06proto3"
...
var file_apiserver_v1_healthz_proto_depIdxs = []int32{
	0, // 0: v1.HealthResponse.status:type_name -> v1.ServiceStatus
