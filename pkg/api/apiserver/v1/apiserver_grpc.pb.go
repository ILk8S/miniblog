...
func (c *miniBlogClient) Healthz(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedMiniBlogServer) Healthz(context.Context, *emptypb.Empty) (*HealthResponse, error) {
